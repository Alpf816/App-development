...
####esta es la principal...................................................................
    def inicializarUI(self):
        ...
        self.setWindowTitle("Interfaz_v1.1") 
        self.create_dock1()
        self.create_dock2()
...
#####esta es una secundaria..................................................
    ...
    def create_dock1(self):
        #Subtitulo1 = QLabel("ingreso de distancia entre los puntos.")
        #lbl11 = QLabel("Distancia Rojo,Amarillo EJEX")
        #lbl12 = QLabel("Distancia Rojo,Azul EJEY")
        #self.disX = QLineEdit()
        #self.disY = QLineEdit()
        #boton1 = QPushButton("Sobreescribir Datos")
        #vertical_layout1 = QVBoxLayout()
        #h_layout_11 = QHBoxLayout()
        #h_layout_12 = QHBoxLayout()
        #h_layout_11.addWidget(lbl11)
        #h_layout_11.addWidget(self.disX)
       
        #h_layout_12.addWidget(lbl12)
        #h_layout_12.addWidget(self.disY)
       

        #vertical_layout1.addWidget(Subtitulo1)
        #vertical_layout1.addLayout(h_layout_11)
        #vertical_layout1.addLayout(h_layout_12)
        #vertical_layout1.addWidget(boton1)
        ...
        #self.dock1.setLayout(vertical_layout1)
