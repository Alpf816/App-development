            ...
            while self.capturando:
                if not self.pausado:
                    ...
                    if self.O_ROI_1x is not None and self.O_ROI_1y is not None and self.WH_ROI_1x is not None and self.WH_ROI_1y is not None:
                        cv2.rectangle(self.frame_video_ventanacentral, (self.O_ROI_1x, self.O_ROI_1y), (self.O_ROI_1x + self.WH_ROI_1x, self.O_ROI_1y + self.WH_ROI_1y), (0, 255, 0), 2)

                    if self.O_ROI_2x is not None and self.O_ROI_2y is not None and self.WH_ROI_2x is not None and self.WH_ROI_2y is not None:
                        cv2.rectangle(self.frame_video_ventanacentral, (self.O_ROI_2x, self.O_ROI_2y), (self.O_ROI_2x + self.WH_ROI_2x, self.O_ROI_2y + self.WH_ROI_2y), (0, 255, 0), 2)

                    if self.O_ROI_3x is not None and self.O_ROI_3y is not None and self.WH_ROI_3x is not None and self.WH_ROI_3y is not None:
                        cv2.rectangle(self.frame_video_ventanacentral, (self.O_ROI_3x, self.O_ROI_3y), (self.O_ROI_3x + self.WH_ROI_3x, self.O_ROI_3y + self.WH_ROI_3y), (0, 255, 0), 2)

                    if self.O_ROI_4x is not None and self.O_ROI_4y is not None and self.WH_ROI_4x is not None and self.WH_ROI_4y is not None:
                        cv2.rectangle(self.frame_video_ventanacentral, (self.O_ROI_4x, self.O_ROI_4y), (self.O_ROI_4x + self.WH_ROI_4x, self.O_ROI_4y + self.WH_ROI_4y), (0, 255, 0), 2)
...
class VideoWidget(QWidget):
    ...
    ROI_1_Datos = pyqtSignal(int,int,int,int)
    ROI_2_Datos = pyqtSignal(int,int,int,int)
    ROI_3_Datos = pyqtSignal(int,int,int,int)
    ROI_4_Datos = pyqtSignal(int,int,int,int)
...
#generacion de UI Principal-----------------------------------------
    def inicializarUI(self):
        ...
        self.setWindowTitle("Interfaz_v5.2 Implementacion de ROI") 
