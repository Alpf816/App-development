...
class ImageProcessorThread(QThread):
    ...
    def __init__(self, get_frame_function, dic_thread,input_queue_ROI1,input_queue_ROI2,input_queue_ROI3,input_queue_ROI4,hilo_video):
        ...
        self.Bucle_frames_processados_1 = None
        self.Bucle_frames_processados_2 = None
        self.Bucle_frames_processados_3 = None
        self.Bucle_frames_processados_4 = None
        self.process_1 = VideoProcess(self.input_queue_ROI1,self.output_queue_ROI1,self.DIC_Queue_ROI_1)
        self.Bucle_frames_processados_1 = VideoProcessingThread(self.output_queue_ROI1,self.processed_frame_signal)
        self.process_2 = VideoProcess(self.input_queue_ROI2,self.output_queue_ROI2,self.DIC_Queue_ROI_2)
        self.Bucle_frames_processados_2 = VideoProcessingThread(self.output_queue_ROI2,self.processed_frame_signal1)
        self.process_3 = VideoProcess(self.input_queue_ROI3,self.output_queue_ROI3,self.DIC_Queue_ROI_3)
        self.Bucle_frames_processados_3 = VideoProcessingThread(self.output_queue_ROI3,self.processed_frame_signal2)
        self.process_4 = VideoProcess(self.input_queue_ROI4,self.output_queue_ROI4,self.DIC_Queue_ROI_4)
        self.Bucle_frames_processados_4 = VideoProcessingThread(self.output_queue_ROI4,self.processed_frame_signal3)
...
class VideoProcess(multiprocessing.Process):
    def __init__(self,input_queue_ROI,output_queue_ROI,DIC_Queue):
    ...
    def run(self):
        ...
        try:
            ...
            print(f"Excepción en el process: {e}")
...
class VideoProcessingThread(QThread):
    def __init__(self,output_queue_ROI,processed_frame_signal):
        super().__init__()
...
#generacion de UI Principal-----------------------------------------
    def inicializarUI(self):
        ...
        self.setWindowTitle("Interfaz_v6.3") 
