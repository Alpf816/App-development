...
class MainWindow(QWidget):
    ...
    def closeEvent(self, event):
        ...
        for processor in self.image_processors:
            processor.join()
            #time.sleep(0.1)  # Pequeño retardo para permitir la finalización del proceso
            print(f"ImageProcessor {processor.pid} terminated.")
    ...
    def process_finished_handler(self):
        print("ImageProcessor has finished.")
