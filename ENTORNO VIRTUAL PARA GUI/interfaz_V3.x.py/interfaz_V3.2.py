...
width_contenedor1 = int
height_contenedor1 = int
...
class VideoStreamThread(QThread):
    ...
    def run(self):
        ...
        while self.capturando:
            ...
            h, w, ch = frame_video_ventanacentral.shape
            bytes_per_line = ch * w
            q_image = QImage(frame_video_ventanacentral.data, w, h, bytes_per_line, QImage.Format.Format_RGB888)
            pixmap = QPixmap.fromImage(q_image)
...
class MiVentana(QWidget):
    def __init__(self):
        ...
        layout_botones.addWidget(boton_iniciar)
        layout_botones.addWidget(boton_detener)

        layout_principal.addWidget(self.video_widget)
...
#Primer dock---------------------------------------------------
    ...
    def create_ventana_central(self):
        global width_contenedor1
        global height_contenedor1
        tab_bar = QTabWidget(self)
        self.contenedor1 = QWidget()
        main_v_contenedor1_box = QVBoxLayout()
        h_contenedor1_box = QHBoxLayout()
        ventana_video_principal = MiVentana()
        h_contenedor1_box.addWidget(ventana_video_principal)

        h_contenedor2_box = QHBoxLayout()
        ...
        h_contenedor2_box.addWidget(self.image_label1)
        h_contenedor2_box.addWidget(self.image_label2)

        self.contenedor1.setLayout(main_v_contenedor1_box)
        main_v_contenedor1_box.addLayout(h_contenedor1_box)
        main_v_contenedor1_box.addLayout(h_contenedor2_box)
        ...
        width_contenedor1 = self.contenedor1.width()
    ...
    def create_dock_2(self):
        ...
        self.contenedor_de_widgets = QWidget()
        main_layout_dock_2 = QGridLayout()
                # Crear widgets
        ...
        self.start_button_b = QPushButton("Encender cámara", self)
        self.stop_button_b = QPushButton("Apagar cámara", self)        
        button_1 = QPushButton("Iniciar Mascaras")
        button_2 = QPushButton("Finalizar Mascaras")


        # Conectar botones a funciones
        self.start_button_b.clicked.connect(self.start_camera)
        self.stop_button_b.clicked.connect(self.stop_camera)



        # Layout
        main_layout_dock_2.addWidget(button_1,1,1,1,1)
        main_layout_dock_2.addWidget(button_2,1,2,1,1)
        main_layout_dock_2.addWidget(self.label,2,1,1,1)
        main_layout_dock_2.addWidget(self.label2,2,2,1,1)
        main_layout_dock_2.addWidget(self.label3,3,1,1,1)
        main_layout_dock_2.addWidget(self.label,3,2,1,1)
        ...
        main_layout_dock_2.setRowStretch(8,1)
        
        
        
        self.contenedor_de_widgets.setLayout(main_layout_dock_2)
        ...
        self.timer.start(50)  # Establecer el intervalo del temporizador (en milisegundos)
